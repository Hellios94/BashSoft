...
namespace BashSoft.IO.Commands
{
    ...
    public class PrintOrderedStudentsCommand : Command
    {
        ...
        public override void Execute()
        {
            ...
            TryParseParameterForOrderAndTake(takeCommand, takeQuantity, courseName, filter);

        }

        private void TryParseParameterForOrderAndTake(string takeCommand, string takeQuantity, string courseName, string filter)
        {
            if (takeCommand == "take")
            {
                if (takeQuantity == "all")
