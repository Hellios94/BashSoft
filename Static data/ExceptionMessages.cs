...
namespace BashSoft
{
    public class ExceptionMessages
    {
        ...
        public const string DataIsAlredyInitializedException = "Data is already initialized!";

        public const string DataNotInititializedExceptionMessage = "The data structure must be initialized first in order to make any operations with it.";
        ...
        public const string UnableToGoHigherInPartitionHierarchy = "Lenght cannot be less than zero.";
        ...
        public const string StudentAlredyEnrolledInGivenCourse = "The {0} already exists in {1}.";
        ...
        public const string InvalidDestination = "The Destination is Invalid";
